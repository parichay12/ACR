...
import com.acr.utils.DockerUtils;
import com.acr.utils.SSHShell;
import com.acr.utils.Utils;
...
public class AcrServices {
     ...
     */
    public boolean runSample(Azure azure, String clientId, String secret,String rgName,String acrName) {
       ...
       // final String acrName = SdkContext.randomResourceName("acrsample", 20);
        ...
        final Region region = Region.INDIA_SOUTH;
    ...
    public static void main(String[] args) {
        try {
           ...
           // runSample(azure, client, key,rgName,acrName);
        } catch (Exception e) {
